...
`,
  ...
  ogDescription: 'Key profitability benchmarks for small accounting firms in 2026. Revenue per partner, utilization, realization, and how AI tools shift the economics.',
  category: 'Accounting',
};
