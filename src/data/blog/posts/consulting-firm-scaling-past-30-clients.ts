...
`,
  ...
  ogDescription: 'How boutique consulting firms scale past 30 clients without quality loss. The real bottleneck is engagement context management, not headcount or pricing.',
  category: 'Consulting',
};
