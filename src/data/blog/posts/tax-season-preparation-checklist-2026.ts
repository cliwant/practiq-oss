...
`,
  ...
  ogDescription: 'Complete 2026 tax season preparation checklist for small CPA firms. Document timelines, client communication templates, tech setup, and capacity planning.',
  category: 'Accounting',
};
