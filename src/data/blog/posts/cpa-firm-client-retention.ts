...
`,
  ...
  ogDescription: 'Why CPA firm clients leave and how to retain them. The top causes are responsiveness gaps, feeling forgotten, and context-driven errors, not price or competence.',
  category: 'Accounting',
};
