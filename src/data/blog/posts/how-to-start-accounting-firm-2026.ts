...
`,
  ...
  ogDescription: 'Practical tech stack guide for new accounting firm owners. What tools to set up, where things break at 20 and 50 clients, and how to build for scale from day one.',
  category: 'Accounting',
};
