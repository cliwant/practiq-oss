...
`,
  ...
  ogDescription: 'Honest comparison of CPA practice management software for small firms in 2026. Karbon, TaxDome, Canopy, and AI-native alternatives evaluated for real-world use.',
  category: 'Accounting',
};
