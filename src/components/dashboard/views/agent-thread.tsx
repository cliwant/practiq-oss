          ...
          <div className="max-w-3xl 2xl:max-w-4xl mx-auto">
            <div className="flex items-center gap-3 px-1 py-3">
              ...
              <div className="flex items-center gap-2">
                <span className="text-xs text-zinc-500">FractionalOS is thinking</span>
      ...
      {active && (
        <div className="px-6 py-2.5 flex items-center justify-between">
          <div className="text-xs text-zinc-500 truncate">
            {active.description || `${active.type === "team" ? "Team conversation" : active.type === "private" ? "Just you and FractionalOS" : "Focused thread"}`}
          </div>
    ...
    <div className="flex gap-3">
      ...
      <div className="flex-1 space-y-2">
        <div className="flex items-baseline gap-2">
          <span className="text-sm font-medium text-zinc-300">FractionalOS</span>
      ...
      <div className="flex-1 space-y-2">
        <div className="flex items-baseline gap-2">
          <span className="text-sm font-medium text-zinc-300">
            {isAI ? "FractionalOS" : sharedByMember?.name}
          </span>
    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-6 bg-black/70 backdrop-blur-md" onClick={onClose}>
      ...
      >
        ...
        <div className="px-6 py-4 border-t border-zinc-800 flex items-center justify-between">
          <div className="text-xs text-zinc-500">Drafted by FractionalOS · pending your review</div>
          <div className="flex items-center gap-2">
            <button
              onClick={onReject}
              className="text-sm text-zinc-300 hover:bg-zinc-800 px-4 py-2 rounded-md transition-colors"
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="mt-6 p-4 rounded-md border border-zinc-800 bg-zinc-900/40">
        <div className="text-xs font-medium text-zinc-500 mb-2">FractionalOS notes</div>
